...
const testimonials = [
  {
    ...
    name: "Johnna Beatrice M. Axalan",
    company: "jbaxalan@mcm.edu.ph",
    categories: [1, 2],
  },
  {
    img: TestimonialImg02,
    clientImg: ClientImg02,
    name: "Korrine Lyle T. Ortiz",
    company: "klOrtiz@mcm.edu.ph",
    content:
  ...
  },
  {
    ...
    name: "Trisha Lynn D. Pond",
    company: "tlPond@mcm.edu.ph",
    content:
  ...
  },
  {
    ...
    name: "Ayanna Keisha B. Ayucan",
    company: "akbAyucan@mcm.edu.ph",
    content:
      "Content creation used to be a bottleneck in our workflow, but not anymore. This AI tool is intuitive and produces top-notch content every time. It's like having an extra team member who never sleeps! Definitely recommend.",
    categories: [1, 5],
  },
...
export default function Testimonials() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6" data-aos="fade-right">
